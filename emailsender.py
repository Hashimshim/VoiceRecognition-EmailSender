...
#Dictionnary of contacts
dict = {'me':'me@gmail.com','college':'college@gmail.com','person':'person@gmail.com'}
#
engine = pyttsx3.init('sapi5') 
voices = engine.getProperty('voices') # getting different voices
engine.setProperty('voice',voices[2].id) # voice chosen
#
def speak(audio):
    engine.say(audio)
    engine.runAndWait()
...
def sendEmail(to,content):
    ...
    server.login('emailtosendfrom@gmail.com','password')
    server.sendmail('emailtosendfrom@gmail.com',to,content) # from, to, content
